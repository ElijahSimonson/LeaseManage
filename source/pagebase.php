...
if (!isset($_SESSION['user']) && basename($_SERVER['PHP_SELF']) != 'login.php'){
	$login = 'login.php?page=' . basename($_SERVER['PHP_SELF']);
...
if (file_exists('source/api.php')){
	include('source/api.php');
}elseif (file_exists('../source/api.php')) {
	include('../source/api.php');
}
?>
	...
	<link rel="stylesheet" type="text/css" href="source/jquery-ui.css" media="screen">
...
<div class="menu">
	...
	if (isset($_SESSION['access'])){
		if($_SESSION['access'] > 0){
			echo "<input type='button' class='admin' onclick=\"location.href='admin/adminConsole.php'\" value='Admin Controls'><br/>"; 
		}
	}
